# Source-JSON gap report: smWhiteScars

**JS file:** `war/js/unitProfiles.smWhiteScars.js`
**Source-JSON file:** `war/source-json/space-marine-white-scars.json`

| Metric | Count |
|---|---|
| JS profiles | 80 |
| Source-JSON profiles | 91 |
| Shared (by name, case-insensitive) | 80 |
| **Missing in source-json (needs transcription)** | **0** |
| Missing in JS (informational) | 11 |
