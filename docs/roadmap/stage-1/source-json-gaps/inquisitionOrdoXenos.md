# Source-JSON gap report: inquisitionOrdoXenos

**JS file:** `war/js/unitProfiles.inquisitionOrdoXenos.js`
**Source-JSON file:** `war/source-json/inquisition-ordo-xenos.json`
